...
@if(!empty($records))
    <div class="card">
        <div class="card-header">
            <a class="btn btn-outline-primary" style="width: 100px;" href="{{route('role.create')}}">
                            ...
                            @foreach($records as $record)
                                    @if($loop->odd)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{$record->name}}</td>
                                            <td>
                                                <a class="btn btn-primary btn-group-vertical" style="width: 90%; margin-left: 5%" href="{{url(route('role.edit', $record->id))}}">
                                                    <i class="fa fa-edit" ></i>
                                                </a>
                                            </td>
                                            <td>
                                                {!! Form::open(['method' => 'POST', 'action' => ['Role\RoleController@destroy', $record->id]]) !!}
