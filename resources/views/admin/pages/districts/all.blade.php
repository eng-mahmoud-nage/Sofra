...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a class="btn btn-outline-primary" style="width: 100px;" href="{{url(route('district.create'))}}">
                                ...
                                @foreach($records as $record)
                                    @if($loop->odd)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a class="btn btn-primary btn-group-vertical" style="width: 90%; margin-left: 5%" href="{{url(route('district.edit', $record->id))}}">
                                                    <i class="fa fa-edit" ></i>
                                                </a>
                                            </td>
                                            <td>
                                                {!! Form::open(['method' => 'POST', 'action' => ['DistrictController@destroy', $record->id]]) !!}
